                  ...
                  <tr key={d.id} className="border-b border-border/30 last:border-0 hover:bg-bg-elevated transition-all duration-fast">
                    ...
                    <td className="px-3 py-4">
                      ...
                      {currentUser.cargo === 'ADMINISTRADOR' ? (
                        ...
                        <span className="inline-flex items-center gap-1.5 bg-bg-elevated border border-border rounded px-2 py-1.5 font-mono text-xs text-text-muted cursor-not-allowed">
